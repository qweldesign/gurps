...
export type { ActionKey, ActionOptions, ActionRequest, ActionResult, InjuryOnLimbResult, ShieldResult, FeintResult, SpellResult, FlashResult, HealResult, CleanseResult, FullPower, Aim }
