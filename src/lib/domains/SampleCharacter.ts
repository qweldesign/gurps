...
const EQUIPMENTS_TABLE: [WeaponName, ArmorName][][][] = [
  [ // 重戦士, 術戦士F
    [['ロングソード', '服'], ['ロングソード', '革鎧'], ['バスタードソード', 'ブリガンディ'], ['バスタードソード', 'プレイトメイル']],
    [['鎚槌', '革服'], ['鎚槌', '革鎧'], ['戦鎚', 'ブリガンディ'], ['戦鎚', 'プレイトメイル']],
    [['手斧', '革服'], ['手斧', '革鎧'], ['戦斧', 'ブリガンディ'], ['戦斧', 'プレイトメイル']]
  ],
  [ // 軽戦士
    [['三日月刀', '服'], ['三日月刀', '革鎧'], ['蒼龍刀', 'チェインメイル'], ['蒼龍刀', 'ブリガンディ']],
    [['ロングソード', '服'], ['ロングソード', '革鎧'], ['グレートソード', 'チェインメイル'], ['グレートソード', 'ブリガンディ']],
    [['長槍', '革服'], ['鉾槍', '革鎧'], ['鉾槍', 'チェインメイル'], ['鉾槍', 'ブリガンディ']]
  ],
  [ // 術戦士B
    [['ショートソード', '服'], ['ロングソード', '革服'], ['バスタードソード', '革鎧'], ['バスタードソード', 'チェインメイル']],
    [['ショートソード', '服'], ['三日月刀', '革服'], ['蒼龍刀', '革鎧'], ['蒼龍刀', 'チェインメイル']],
    [['長槍', '服'], ['薙刀', '革服'], ['薙刀', '革鎧'], ['薙刀', 'チェインメイル']]
  ],
  [ // 剣士, 盗賊, 術剣士
